...
Type BASS_ASIO_INFO
        ...
        initflags As Long     'BASS_ASIO_Init "flags" parameter
End Type
...
Global Const BASS_ASIO_FORMAT_DSD_LSB = 32 'DSD (LSB 1st)
Global Const BASS_ASIO_FORMAT_DSD_MSB = 33 'DSD (MSB 1st)
Global Const BASS_ASIO_FORMAT_DITHER = &H100 'flag: apply dither when converting from floating-point to integer
...
Global Const BASS_ASIO_RESET_JOINED = &H10000 'apply to joined channels too
...
Global Const BASS_ASIO_LEVEL_RMS = &H1000000


Declare Function BASS_ASIO_GetVersion Lib "bassasio.dll" () As Long
Declare Function BASS_ASIO_SetUnicode Lib "bassasio.dll" (ByVal unicode As Long) As Long
...
Declare Function BASS_ASIO_AddDevice Lib "bassasio.dll" (ByVal clsid As Long, ByVal driver As String, ByVal name As String) As Long
...
Declare Function BASS_ASIO_Init Lib "bassasio.dll" (ByVal device As Long, ByVal flags As Long) As Long
...
Declare Function BASS_ASIO_CheckRate Lib "bassasio.dll" (ByVal rate_ As Double) As Long
...
Declare Function BASS_ASIO_Start Lib "bassasio.dll" (ByVal buflen As Long, ByVal threads As Long) As Long
...
Declare Function BASS_ASIO_ChannelEnableBASS Lib "bassasio.dll" (ByVal input_ As Long, ByVal channel As Long, ByVal handle As Long, ByVal join As Long) As Long
...
Declare Function BASS_ASIO_SetDSD Lib "bassasio.dll" (ByVal dsd As Long) As Long
Declare Function BASS_ASIO_Future Lib "bassasio.dll" (ByVal selector As Long, ByVal param As Any) As Long
...
Sub ASIONOTIFYPROC(ByVal notify As Long, ByVal user As Long)
