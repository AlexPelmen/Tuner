...
int vol[KEYS], pos[KEYS];	// keys' volume & pos
double samrate;
...
void main(int argc, char **argv)
{
	...
	BASS_ASIO_ChannelEnable(FALSE, 0, AsioProc, (void*)str); // enable 1st output channel...
	BASS_ASIO_ChannelJoin(FALSE, 1, 0); // and join the next channel to it (stereo)
	BASS_ASIO_ChannelSetFormat(FALSE, 0, BASS_ASIO_FORMAT_16BIT); // set the source format (16-bit)
